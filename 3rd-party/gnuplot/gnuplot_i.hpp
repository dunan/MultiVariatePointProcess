...
class Gnuplot
{
    ...
    ///  or when generating the same plot for several devices (showonscreen, savetopdf)
    /// 
    /// \param ---
    ///
    /// \return ---
...
std::string Gnuplot::m_sGNUPlotPath = "/c/tools/gnuplot/bin/";
...
std::string Gnuplot::terminal_std = "pdfcairo";
#endif
