...
private:
	...
	std::string x_label_, y_label_, title_;

public:

	Plot(const std::string& x_label, const std::string& y_label, const std::string& title) : x_label_(x_label), y_label_(y_label), title_(title){}
